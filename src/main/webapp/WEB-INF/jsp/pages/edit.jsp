                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-10 ml-auto mr-auto">
                                    ...
                                    <%--@elvariable id="userFormOne" type=""--%>
                                    <form:form cssClass="form" method = "post" modelAttribute="userFormEdit" action="${pageContext.request.contextPath}/edit">
                                        <spring:bind path="userId">
                                            <div class="form-group has-default">
                                                <div class="input-group">
                                                    ...
                                                    <form:input cssClass="form-control" cssStyle="pointer-events: none "  placeholder="First Name..." path="userId"/>
                                                </div>
                                            </div>
                                        </spring:bind>
                                        ...
                                        <spring:bind path="lastName">
                                            <div class="form-group has-default">
                                                <div class="input-group">
                                                    ...
                                                    <form:input cssClass="form-control" placeholder="Last Name..." path="lastName"/>
                                                </div>
                                            </div>
                                        </spring:bind>
                                        ...
                                        <spring:bind path="email">
                                            <div class="form-group has-default">
                                                <div class="input-group">
                                                    ...
                                                    <form:input placeholder="Password..." cssClass="form-control" path="password"/>
                                                </div>
                                            </div>
                                        </spring:bind>
