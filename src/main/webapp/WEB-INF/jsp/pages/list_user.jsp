                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <center><a href="${pageContext.request.contextPath}/addNew"> <form:button class="btn btn-primary btn-round mt-4">Add New</form:button></a> </center>
                            </div>
                            <div class="card-body">
                                <div class="toolbar">
                                ...
                                <div class="material-datatables">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>${item.email}</td>
                                            <td class="text-right">
                                                <a href="${pageContext.request.contextPath}/${item.userId}" class="btn btn-link btn-warning btn-just-icon edit">
