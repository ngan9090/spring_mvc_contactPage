...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
        <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">ADD NEW</a>
        </div>
            ...
            <div class="row">
                <div class="col-md-10 ml-auto mr-auto">
                    <div class="card card-signup">
                        <h2 class="card-title text-center">Add  New</h2>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-10 ml-auto mr-auto">
                                    ...
                                    <form:form cssClass="form" method="post" modelAttribute="userFormAdd" action="${pageContext.request.contextPath}/addNew">
                                        <form:hidden path="id" />
                                        ...
                                        <spring:bind path="email">
                                            <div class="form-group has-default">
                                                <div class="input-group">
                                                    ...
                                                    <form:password placeholder="Password..." cssClass="form-control" path="password"/>
                                                </div>
                                            </div>
                                        </spring:bind>
